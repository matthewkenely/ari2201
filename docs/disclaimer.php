...
<body>
    ...
    <main>
        <div id="disclaimer">
            ...
            <p>The application may retrieve news articles that contain sensitive information, such as crime or tragedy. Articles which may be deemed inappropriate are filtered out by default. However, please be aware that this filter has been developed subjectively and, as such, the application cannot guarantee complete avoidance of sensitive content.</p>
