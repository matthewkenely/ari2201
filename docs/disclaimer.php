...
<body>
    ...
    <main>
        ...
        <p>The application extracts location information from news articles, which may not always be accurate. Efforts have been made to train an accurate Named Entity Recognition (NER) algorithm. However, please be aware that there might be limitations or errors in the provided information. Users are advised to verify the information from reliable sources.</p>
